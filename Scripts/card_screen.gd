...
var cards = [
	...
	{"title":"","desc":"the dev of this game decided to straight up steal cards from rounds so you now have faster bullets","effect":"_windUpUpgrade"},
	{"title":"","desc":"your barrel started a diet making the bullet spread to go down","effect":"_barrelDietUpgrade"},
	{"title":"","desc":"you stole a thruster from nasa and put it on your gun","effect":"_thrusterUpgrade"},
	{"title":"","desc":"compensating for something? yes do bullets fly further? also yes","effect":"_longBarrelUpgrade"},
]
var shown = [0,0,0]
var pool : Array = []
var waves = null
